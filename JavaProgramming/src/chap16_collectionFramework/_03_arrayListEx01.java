...
import HomeworkAnswer.homework0321.ContractEmployee;
import HomeworkAnswer.homework0321.Employee;
import HomeworkAnswer.homework0321.RegularEmployee;
import HomeworkAnswer.homework0321.TempEmployee;
		...
		while(true) {
			...
			switch(input) {
				...
				case 2 : 
					...
					hireYear = sc.nextInt();
					epList.add(new TempEmployee(eno, name, pay, 3,hireYear));
					epList.get(epList.size() -1).showEmployeeInfo();
					System.out.println("----------------");
					break;
				case 3 : 
					...
					workDay = sc.nextInt();
					epList.add(new ContractEmployee(eno, name, pay,1, hireYear));
					epList.get(epList.size() -1).showEmployeeInfo();
					System.out.println("----------------");
					break;
				case 4 : 
