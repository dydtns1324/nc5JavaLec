...
public class _18_calendar {
	...
	public static void main(String[] args) {
		...
		//hour(시간)은 오전, 오후 상관없이 0 ~ 11로 시간을 표시
		...
		//요일은 1부터 시작 1(일요일) ~ 7(토요일)
		 System.out.println("무슨 요일 : " +today.get(Calendar.MONDAY));
		...
		System.out.println("무슨 요일 : " + oneDay.get(Calendar.DAY_OF_WEEK_IN_MONTH));
	
		System.out.println("oneDay는 " +
		                   days[oneDay.get(Calendar.YEAR)] + "년 " +
